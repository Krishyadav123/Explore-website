          ...
          <div className="relative z-10">
            ...
            <div className="text-center space-y-3 text-base md:text-lg">
              <p className="text-blue-100">
                Setting clear financial goals is the first step towards securing your future.
              </p>
              <p className="text-blue-100">
                Our calculator helps you define, plan, and achieve your most important financial milestones.
              </p>
            </div>

            <div className="mt-10 text-center">
              <p className="text-lg md:text-xl font-medium text-blue-100">
                🌟 Define your goals, plan your investments, and make your dreams a reality!
              </p>
              <div className="mt-8">
                <a
