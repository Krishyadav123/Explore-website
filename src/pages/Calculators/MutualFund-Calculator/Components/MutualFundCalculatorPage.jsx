          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">
                🌟 Ready to Boost Your SIP Returns?
              </h3>
            </div>

            <div className="text-center space-y-3 text-base md:text-lg">
              <p className="text-blue-100">
                Stepping up your SIP investments can significantly accelerate your wealth creation.
              </p>
              <p className="text-blue-100">
                Our calculator shows you the power of increasing your contributions over time.
              </p>
            </div>

            <div className="mt-10 text-center">
              <p className="text-lg md:text-xl font-medium text-blue-100">
                🌟 Step up your SIP, maximize your growth, and achieve financial freedom faster!
              </p>
              <div className="mt-8">
                <a
