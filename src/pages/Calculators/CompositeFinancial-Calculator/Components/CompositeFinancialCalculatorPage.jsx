          ...
          <div className="relative z-10">
            ...
            <div className="text-center space-y-3 text-base md:text-lg">
              <p className="text-blue-100">
                Managing multiple financial goals can be complex, but it's essential for a secure future.
              </p>
              <p className="text-blue-100">
                Our Composite Financial Calculator helps you integrate and achieve all your financial aspirations.
              </p>
            </div>

            <div className="mt-10 text-center">
              <p className="text-lg md:text-xl font-medium text-blue-100">
                🌟 Plan comprehensively, invest strategically, and achieve all your financial dreams!
              </p>
              <div className="mt-8">
                <a
