...
const ExploreHero = () => {
  ...
  const services = [
    ...
    {
      icon: Shield,
      name: "Goal-Based Wealth Planning",
      active: activeService === 1,
    },
    {
      icon: Target,
      name: "Global Mutual Fund Access",
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-2xl lg:text-4xl font-bold text-gray-900 leading-tight mb-6">
                ...
                <span className="block mt-2">
                  Backed by{" "}
                  <span className="text-orange-500">13+ Years of Trust</span>
                </span>
              </h1>

              {/* Description */}
              <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-xl">
                We help individuals and NRIs make informed investment decisions
                through AI-driven insights, personalized wealth strategies, and
                global mutual fund solutions. From retirement planning to
                funding your children’s education, our approach ensures every
                step is aligned with your unique goals.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
              From AI-backed risk profiling to global investment solutions,
              Explore offers a client-first approach to help you plan, grow, and
